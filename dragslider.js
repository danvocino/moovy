// jquery ui slider widget extension for a rangeDrag feature
// allows the user to drag the entire range at once, rather than having to drag the handles to move the range
